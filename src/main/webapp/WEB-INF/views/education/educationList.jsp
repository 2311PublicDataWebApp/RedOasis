...
text-decoration-line : none;}
  ...
  <jsp:include page="../../inc/header.jsp"></jsp:include>
    ...
    <body id="page-top">
      ...
      <div style="margin-top: 200px;">
		<div style="margin-top: 200px; margin-bottom: 20px; margin-left: 50px; ">
          <button type="button" class="btn btn-secondary" disabled>교육</button>
          /
          <button type="button" class="btn btn-primary"  onclick="location.href='/tasting/list.kw'">시음회</button>
        </div>
     	<table>
     		<thead>
    <tr>
    ...
    <tr>
        ...
        <td class="left"><a href="/education/detail.kw?educationNo=${education.educationNo}">${education.educationName}</a></td>
        <td class="left">${education.educationLocation}</td>
        <td class="center">${education.educationTeacher}</td>
        <td class="center">${education.educationDate}</td>   
    </tr>
    </c:forEach>
    </tbody>
</table>
